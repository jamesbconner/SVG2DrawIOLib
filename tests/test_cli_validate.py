...
class TestValidateCommand:
    ...
    def test_validate_missing_required_field(
        ...
        library.write_text(
            '<?xml version="1.0"?>'
            '<mxlibrary>[{"xml":"test","w":100,"title":"test"}]</mxlibrary>'
        )
    ...
    def test_validate_invalid_dimensions(
        self, runner: CliRunner, tmp_path: Path
    ) -> None:
    ...
    def test_validate_negative_dimensions(
        self, runner: CliRunner, tmp_path: Path
    ) -> None:
    ...
    def test_validate_invalid_mxgraphmodel(
        self, runner: CliRunner, tmp_path: Path
    ) -> None:
    ...
    def test_validate_unparseable_mxgraphmodel(
        self, runner: CliRunner, tmp_path: Path
    ) -> None:
    ...
    def test_validate_multiple_icons(self, runner: CliRunner, tmp_path: Path) -> None:
        ...
        result = runner.invoke(
            cli, ["create", str(svg1), str(svg2), "-o", str(library)]
        )
        assert result.exit_code == 0
    ...
    def test_validate_mixed_valid_invalid_icons(
        self, runner: CliRunner, tmp_path: Path
    ) -> None:
    ...
    def test_validate_non_string_xml_field(
        self, runner: CliRunner, tmp_path: Path
    ) -> None:
    ...
    def test_validate_non_array_json(self, runner: CliRunner, tmp_path: Path) -> None:
        ...
        library.write_text(
            '<?xml version="1.0"?><mxlibrary>{"not":"an array"}</mxlibrary>'
        )
    ...
    def test_validate_svg_with_invalid_base64(
        self, runner: CliRunner, tmp_path: Path
    ) -> None:
    ...
    def test_validate_svg_with_invalid_xml(
        self, runner: CliRunner, tmp_path: Path
    ) -> None:
        ...
        mxgraph_xml = f"""<mxGraphModel><root><mxCell id="0"/><mxCell id="1" parent="0"/><mxCell id="2" style="shape=image;image=data:image/svg+xml,{encoded_svg}" vertex="1" parent="1"><mxGeometry width="100" height="100" as="geometry"/></mxCell></root></mxGraphModel>""".encode("utf-8")
    ...
    def test_validate_svg_with_non_utf8(
        self, runner: CliRunner, tmp_path: Path
    ) -> None:
    ...
    def test_validate_svg_with_unexpected_root(
        self, runner: CliRunner, tmp_path: Path
    ) -> None:
        ...
        svg_content = '<?xml version="1.0"?><wrongroot xmlns="http://www.w3.org/2000/svg"><rect/></wrongroot>'
    ...
    def test_validate_no_svg_data_uri(
        self, runner: CliRunner, tmp_path: Path
    ) -> None:
    ...
    def test_validate_unexpected_exception_in_icon(
        self, runner: CliRunner, tmp_path: Path
    ) -> None:
    ...
    def test_validate_dimension_type_error(
        self, runner: CliRunner, tmp_path: Path
    ) -> None:
